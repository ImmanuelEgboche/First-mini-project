""""CREATE AND LOAD 2 TABLES WHICH ARE ALREADY POPULATED PRODUCTS ADN COURIERS, ORDERS TABLE WILL BE POPULATED AFTER
i NEED TO READ FROM THE PRODUCT TABLE INSERT TO IT AND UPDATE IT ETC AND SAME WITH COURIER TABLE. THEN USE A JOIN
TO THEN COMPLIE BOTH TABLES ON MY PRIMARY KEY AND THAT WILL BE MY ORDER TABLE."""
import csv
